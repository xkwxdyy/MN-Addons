 ...
 */
/**
 * 夏大鱼羊 - MNNote prototype 保留的扩展 - begin
 */

/**
 * 让卡片独立出来
 * 注意：修改为使用 MNMath.getFirstClassificationParentNote
 */
MNNote.prototype.toBeIndependent = function(){
  let parentNote = MNMath.getFirstClassificationParentNote(this)
  if (parentNote) {
...
/**
 * 夏大鱼羊 - MNNote prototype 保留的扩展 - end
 */
/**
 * 夏大鱼羊 - String.prototype 必要扩展 - begin
 * 这些方法被 MNMath 和 HtmlMarkdownUtils 类使用
 */
...
/**
 * 夏大鱼羊 - String.prototype 必要扩展 - end
 */