...
function getQustionBlock(code) {
  ...
  let keys = Object.keys(config)
    ...
    let encodedContent = encodeURIComponent(code);
      ...
      let questionHTML = `<div style="background: ${backgroundColor}; border: 1px solid ${borderColor}; box-shadow: 0 8px 32px rgba(0,0,0,0.08), 0 2px 8px rgba(0,0,0,0.04);  width: calc(100% - 2px);  border-radius: 16px; padding: 5px; padding-left: 0px; margin: 3px; margin-left: 0px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; " >
